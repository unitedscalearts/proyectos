...
uint8_t fPos = 0;
boolean hStep1 [8] = {HIGH, HIGH, LOW,  LOW,  LOW,  LOW,  LOW,  HIGH};
boolean hStep2 [8] = {LOW,  LOW,  LOW,  HIGH, HIGH, HIGH, LOW,  LOW};
...
void motorStep() {
  ...
  fPos++;
  fPos%=4;/*
  digitalWrite(OUT1, hStep1[fPos]);
  digitalWrite(OUT2, hStep2[fPos]);
  digitalWrite(OUT3, hStep3[fPos]);
  digitalWrite(OUT4, hStep4[fPos]);
  fPos++;
  fPos%=8;*/
}
