...
void tiraVertical() {
  ...
  while (k < (NUM_VERTICAL_1 + NUM_VERTICAL_2 + NUM_VERTICAL_3)) {
    tira2.setPixelColor(k, r[LED_VERTICAL_3], g[LED_VERTICAL_3], b[LED_VERTICAL_3]);
    k++;
  }
  while (k < (NUM_VERTICAL_1 + NUM_VERTICAL_2 + NUM_VERTICAL_3 + NUM_VERTICAL_4)) {
    tira2.setPixelColor(k, r[LED_VERTICAL_4], g[LED_VERTICAL_4], b[LED_VERTICAL_4]);
    k++;
  }
  tira2.show();
}
